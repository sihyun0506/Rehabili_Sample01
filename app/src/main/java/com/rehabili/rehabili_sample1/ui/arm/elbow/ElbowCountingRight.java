package com.rehabili.rehabili_sample1.ui.arm.elbow;
...
public class ElbowCountingRight extends AppCompatActivity implements SensorEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        thread = new Thread() {
            public void run() {
                ...
                Intent intent = new Intent(ElbowCountingRight.this, Finish.class);
